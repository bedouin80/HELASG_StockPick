<script type="text/javascript">
	RED.nodes.registerType('controltimer', {
		category: 'function',
		color: '#C0DEED',
		defaults: {
			name: { value: '', required: false },
			timerType: { value: 'delay' },

			timerDurationUnit: { value: 'second' },
			timerDurationType: { value: 'num' },
			timerDuration: { value: 5, required: true, validate: RED.validators.typedInput('timerDurationType') },

			timerLoopTimeoutUnit: { value: 'second' },
			timerLoopTimeoutType: { value: 'num' },
			timerLoopTimeout: { value: 0, required: true, validate: RED.validators.typedInput('timerLoopTimeoutType') },

            loopTimeoutMessageType: { value: 'str' },
			loopTimeoutMessage: { value: 'LOOP_TIMEOUT', required: true, validate: RED.validators.typedInput('loopTimeoutMessageType') },
            timerMaxLoopIterationsType: { value: 'num' },
			timerMaxLoopIterations: { value: 0, required: true, validate: RED.validators.typedInput('timerMaxLoopIterationsType') },
			loopMaxIterationsMessageType: { value: 'str' },
			loopMaxIterationsMessage: { value: 'MAX_LOOP_ITERATIONS', required: true, validate: RED.validators.typedInput('loopMaxIterationsMessageType') },

			isRunningTimerProgressVisible: { value: true },
            outputReceivedMessageOnTimerTrigger: { value: true },
            outputReceivedMessageOnTimerHalt: { value: false },
            startTimerOnReceivalOfUnknownMessage: { value: false },
            resetTimerOnReceivalOfUnknownMessage: { value: false },
            resetTimerOnReceivalOfStartAction: { value: false },
            continueTimerOnReceivalOfStartAction: { value: false },
			isDebugModeEnabled: { value: false },
			timerTriggeredMessageType: { value: 'str' },
			timerTriggeredMessage: { value: 'TIMER_TRIGGERED', required: true, validate: RED.validators.typedInput('timerTriggeredMessageType') },
			timerHaltedMessageType: { value: 'str' },
			timerHaltedMessage: { value: 'TIMER_HALTED', required: true, validate: RED.validators.typedInput('timerHaltedMessageType') },

            isStartActionEnabled: { value: true },
			isStopActionEnabled: { value: true },
			isResetActionEnabled: { value: true },
			isPauseActionEnabled: { value: true },
			isContinueActionEnabled: { value: true },
			actionPropertyNameType: { value: 'str' },
			actionPropertyName: { value: 'payload', required: true, validate: RED.validators.typedInput('actionPropertyNameType') },
			startActionNameType: { value: 'str' },
			startActionName: { value: 'START', required: true, validate: RED.validators.typedInput('startActionNameType') },
			stopActionNameType: { value: 'str' },
			stopActionName: { value: 'STOP', required: true, validate: RED.validators.typedInput('stopActionNameType') },
			resetActionNameType: { value: 'str' },
			resetActionName: { value: 'RESET', required: true, validate: RED.validators.typedInput('resetActionNameType') },
			pauseActionNameType: { value: 'str' },
			pauseActionName: { value: 'PAUSE', required: true, validate: RED.validators.typedInput('pauseActionNameType') },
			continueActionNameType: { value: 'str' },
			continueActionName: { value: 'CONTINUE', required: true, validate: RED.validators.typedInput('continueActionNameType') },
        },
		inputs: 1,
		outputs: 2,
		icon: "controltimer.png",
		label: function () {
			return this.name || `${this.timerDuration} ${this.timerDurationUnit} ${this.timerType === 'delay' ? 'delay' : 'loop'}`;
        },
        labelStyle: function () {
    ...
    "continueActionName": "CONTINUE"
            ...
            function initializeInputs() {
                ...
                initializeNodeRedCheckbox('resetTimerOnReceivalOfStartAction');
                initializeNodeRedCheckbox('continueTimerOnReceivalOfStartAction');
			...
			$('#node-input-timerType').change(() => {
				...
				if (selectedTimerType === 'loop') {
					$('.loop-options').show();
                }

				if (selectedTimerType === 'delay') {
					$('.loop-options').hide();
				}
			});
			...
			$('#reset-to-default').on('click', () => {
                ...
                this.resetTimerOnReceivalOfStartAction = elementDefaults.resetTimerOnReceivalOfStartAction;
                this.continueTimerOnReceivalOfStartAction = elementDefaults.continueTimerOnReceivalOfStartAction;
        ...
        oneditsave: function () {
            ...
            this.timerDuration = getAndEnsurePositiveNonNullInteger($('#node-input-timerDuration'), 5);
            ...
            this.resetTimerOnReceivalOfStartAction = $('#node-input-resetTimerOnReceivalOfStartAction').is(":checked");
            this.continueTimerOnReceivalOfStartAction = $('#node-input-continueTimerOnReceivalOfStartAction').is(":checked");
...
<script type="text/html" data-template-name="controltimer">
    <style>
    ...
    <div class="controltimer-settings-accordion-panel">
        ...
        <div class="form-row controltimer-input-row">
            <label for="node-input-resetTimerOnReceivalOfStartAction"><i class="fa fa-tag"></i> Reset timer on receival of START action</label>
            <div class="controltimer-input-row-checkbox-wrapper">
                <input type="checkbox" id="node-input-resetTimerOnReceivalOfStartAction">
            </div>
        </div>

        <div class="form-row controltimer-input-row">
            <label for="node-input-continueTimerOnReceivalOfStartAction"><i class="fa fa-tag"></i> Continue timer on receival of START action</label>
            <div class="controltimer-input-row-checkbox-wrapper">
                <input type="checkbox" id="node-input-continueTimerOnReceivalOfStartAction">
            </div>
        </div>
...
<script type="text/html" data-help-name="controltimer">
